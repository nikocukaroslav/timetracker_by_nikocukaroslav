    ...
    return (
        <Modal closeOnOverlayClick={false} isOpen={isOpen} onClose={onClose} isCentered size="xl">
            ...
            <ModalContent>
                ...
                <ModalBody display="flex" flexDirection="column" gap="2" maxHeight="50dvh" overflow="auto">
                    ...
                    <FormLabel display="flex" flexDirection="column" gap="1">
                        <Text>Text</Text>
                        <Textarea placeholder="Type your request here..." borderColor="gray.300"
                                  focusBorderColor="gray.500" height="30dvh"/>
                    </FormLabel>
                </ModalBody>
                <ModalFooter>
